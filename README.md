...
Figure 3: Multiple users can work on the spreadsheet simultaneously.
</div>
...
Figure 4: User can create or load documents from the Document Manager.

<img src="https://github.com/macarious/spreadsheet/assets/63441014/8aafdfae-b119-4e4c-80b9-eb7fde95e1e8" width="400" />

Figure 5: Documents can be selected or deleted via the dropdown menu in the Navigation Bar.
</div>
...
Figure 6: As shown above, the calculator includes advanced functions including radical and trigonometric functions.
</div>
...
Figure 7: The web application can be used on tablets such as the iPad Air.

<img src="https://github.com/macarious/spreadsheet/assets/63441014/3fe24d9b-762b-4ac9-a264-2edc20620ebb" width="600" />

Figure 8: The Document Manager is collapsible, providing users with the ability to create additional space for their viewing preferences.
</div>
